...
import type { GymSummary, StaffRecord, UpdateGym, UpdateOwnStaffProfile } from "./lib/ironcore-api";
...
type LiveMembers = { rows: DashboardMember[]; total: number; loading: boolean; error: string | null; onSearch: (query: string) => void; onReload: () => void; onView?: (memberId: string) => Promise<DashboardMemberProfile>; onInvitePortal?: (memberId: string) => Promise<string>; onUpdate?: (memberId: string, member: UpdateDashboardMember) => Promise<void> };
export type GymSettingsData = { gym: GymSummary; canManage: boolean; onUpdate: (input: UpdateGym) => Promise<void> };
