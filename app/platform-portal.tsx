...
import { PlatformAnalytics, PlatformBillingDashboard, PlatformMemberDirectory, type PlatformBillingActions } from "./platform-insights";
...
export type PlatformPortalData = {
  ...
  onCreateSaasInvoice: PlatformBillingActions["onCreateInvoice"];
  onReviewSaasPayment: PlatformBillingActions["onReviewPayment"];
